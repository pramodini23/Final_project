...
<html lang="en">
	<head>
	    ...
	    <title>Online Farmer Web App</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Good Price</h4>
						</div>
					</div>	
					<h6 class="text">Good price </h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">FREE SHIP-ON ORDER OVER $. 1500</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All items-sale with low cost </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="250" height="250" alt=""></a>
			</div><!-- /.image -->			
...
?>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="350" height="350"></a>
			</div><!-- /.image -->			                        		   
		</div><!-- /.product-image -->
