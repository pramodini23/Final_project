...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Search here..." name="product" required="required" style="border:0px;color:black;"  />

        	<button class="search-button" type="submit" name="search" style="  background-color: white;
  color: black;
  border: 2px solid #41c9d4;"></button> 
